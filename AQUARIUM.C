...
//upper 2nd right fish
arc(300-i,150,50,320,30);
line(320-i,128,350-i,160);
line(320-i,173,350-i,130);
line(350-i,160,350-i,130);
circle(280-i,150,3);
arc(280-i,150,630,450,20);
//lower 2nd left fish
arc(300+i,200,220,150,30);
line(250+i,190,280+i,222);
line(275+i,184,250+i,220);
line(250+i,190,250+i,220);
circle(320+i,200,3);
arc(325+i,200,100,260,20);
